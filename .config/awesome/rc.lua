...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/mycustomtheme/theme.lua")
...
beautiful.useless_gap = 05  -- gap size in pixels


-- convenience
local awful = require("awful")

-- 1) Always set libinput accel profile for all pointers
...
-- 2) Kill any running polybar quietly
awful.spawn.with_shell("killall -q polybar")

-- 3) Wait for polybar to fully exit, then launch your bar
awful.spawn.with_shell([[
